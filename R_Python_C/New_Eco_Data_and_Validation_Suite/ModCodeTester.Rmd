...
#cluster with gaussian distance
```{r}
...
BCIClust <- densityClust(BCI_Noweights, BCIDist, gaussian=TRUE)

#orig = data.matrix(BCI_Noweights, rownames.force = NA)
orig = simplify2array(BCI_Noweights)

BCIComb <- findCluster_validationChart(BCIClust)
